...
namespace CoursesPlatform.Crud
{
    public class Search_crud
    {
        ...
        private static List<Course> search_courses_by_course_type_tag(List<SearchToken> search_tokens)
        {
            ...
            using (SqlConnection con = new SqlConnection(Database.connection_string))
            {
                ...
                com.Parameters.AddWithValue("@Action", "SearchCoursesByCourseTypeTag");
